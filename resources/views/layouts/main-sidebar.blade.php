			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('admin.users.index') }}">قائمة المستخدمين</a></li>
							<li><a class="slide-item" href="{{ route('admin.roles.index') }}">صلاحيات المستخدمين</a></li>
							<li><a class="slide-item" href="{{ route('admin.permissions.index') }}">قائمة الصلاحيات</a></li>
						</ul>
					</li>
					<li class="slide">
